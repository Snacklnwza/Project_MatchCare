...
## 12. แก้ช่องจังหวัดในฟอร์มผู้ป่วย

บน Vercel ช่องจังหวัดเดิมเป็น native select ที่เปิดรายการ 77 จังหวัดสูงเกินพื้นที่ modal ทำให้ใช้งานลำบากใน Chrome ปรับเฉพาะฟอร์มเพิ่ม/แก้ไขผู้ป่วยเป็นช่องค้นหาพร้อมรายการภายในฟอร์ม; ผู้ใช้คลิกผลลัพธ์หรือเลือกด้วยแป้นพิมพ์แล้วค่าจะค้างอยู่ ช่องอำเภอจะเปิดเมื่อชื่อจังหวัดถูกต้องเท่านั้น และหากสะกดไม่ตรงจะมีข้อความผิดพลาดพร้อมป้องกันการบันทึก ทดสอบบน localhost ว่าคลิกเชียงใหม่แล้วค่าไม่หายเมื่อออกจากช่อง, ใช้แป้นพิมพ์เลือกกรุงเทพมหานคร, ชื่อที่ไม่อยู่ในรายการถูกปฏิเสธ และลำดับ เชียงใหม่ → เมืองเชียงใหม่ → ช้างเผือก ผ่าน รวมถึง lint/build ต้องตรวจซ้ำบน Vercel หลัง deploy commit นี้
